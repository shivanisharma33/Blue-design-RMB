    ...
    <section className="relative w-full bg-white py-32 md:py-40 overflow-hidden">
      ...
      >
        ...
        <h2 className="font-display text-4xl md:text-5xl 
                       text-black leading-tight mb-10">
        ...
        <p className="text-lg text-black/70 font-light leading-relaxed mt-6">
        ...
        <motion.div
          className="w-24 h-[1px] 
                     bg-gradient-to-r from-orange via-black to-orange 
                     mx-auto mt-16"
          initial={{ scaleX: 0 }}
      ...
      {/* ================= STATEMENT (Optional Future Content) ================= */}
      <motion.div
